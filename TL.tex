...
\input{ThesisFiles/part1}
\newpage
\input{ThesisFiles/exercise}
\input{ThesisFiles/paper}
\newpage
\input{ThesisFiles/Teacherzhao}
\newpage
\input{ThesisFiles/conference}
\newpage
\input{ThesisFiles/neural_network}
%\newpage
%\input{ThesisFiles/paperBegining}
